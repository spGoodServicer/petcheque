        ...
        <table class="table table-border table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="30%">{{@num_format(($account_detail->balance))}}</td>
                </tr>
                @endforeach
                @php
        ...
        <table class="table table-border table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="30%">{{@num_format(($fixed_assets_accounts_main_balance))}}</td>
                    @php
        ...
        <table class="table table-border table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="30%">{{@num_format(($liabilities_accounts_main_balance))}}</td>
                    @php
        ...
        <table class="table table-border table-striped">
            <tbody>
                ...
                <tr>
                    ...
                    <td width="30%">{{@num_format($equity_accounts->sum('balance'))}}</td>
                </tr>
                @foreach ($equity_accounts_main_balances as $name=>$account_detail)
                <tr>
                    <td>{{$name}}</td>
                    <td>{{@num_format(($account_detail))}}</td>
