  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group parent_account @if(empty($account->parent_account_id)) hide @endif">
        ...
        {!! Form::select('parent_account_id', $parent_accounts, $account->parent_account_id, ['placeholder' =>  __('messages.please_select'), 'style' => 'width: 100%', 'class' => 'form-control select2']) !!}
      </div>
