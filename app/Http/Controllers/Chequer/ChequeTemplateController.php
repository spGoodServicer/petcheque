        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($templates)
                ->addColumn('action', function ($row) {
                    ...
                    <li><a data-toggle="modal" href="'.url('get-templates-link-bank', [$row->id]).'" data-target="#template_link_bank_model"><i class="glyphicon glyphicon-edit"></i> Link Bank Accounts</a></li>
